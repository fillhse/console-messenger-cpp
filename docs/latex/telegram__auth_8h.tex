\doxysection{server/telegram\+\_\+auth.h File Reference}
\hypertarget{telegram__auth_8h}{}\label{telegram__auth_8h}\index{server/telegram\_auth.h@{server/telegram\_auth.h}}
...
Include dependency graph for telegram\+\_\+auth.\+h\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=211pt]{telegram__auth_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{telegram__auth_8h__dep__incl}
\end{center}
\end{figure}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{telegram__auth_8h_a49e6447c01a81c8af7c206e1538510a0}{set\+\_\+bot\+\_\+token}} (const std\+::string \&token)
\begin{DoxyCompactList}\small\item\em Установить глобальный токен Telegram-\/бота. \end{DoxyCompactList}\item 
std\+::string \mbox{\hyperlink{telegram__auth_8h_a74d2f6718acaf08c27fb5c975a939cca}{generate\+\_\+auth\+\_\+code}} ()
\begin{DoxyCompactList}\small\item\em Сгенерировать случайный шестизначный код для авторизации. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{telegram__auth_8h_ad0aadb96417fb892ae3cdaf3e4b24649}{send\+\_\+telegram\+\_\+code}} (const std\+::string \&chat\+\_\+id, const std\+::string \&code)
\begin{DoxyCompactList}\small\item\em Отправить код авторизации через Telegram Bot API. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{telegram__auth_8h_a0bd7efd131f04d1c39a7e97276c64457}{verify\+\_\+auth\+\_\+code}} (const std\+::string \&chat\+\_\+id, const std\+::string \&code)
\begin{DoxyCompactList}\small\item\em Проверить введённый пользователем код авторизации. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{telegram__auth_8h_addc2662ff5190602846d5e93f09aa388}{ensure\+\_\+bot\+\_\+token}} ()
\begin{DoxyCompactList}\small\item\em Убедиться, что глобальный токен бота загружен. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
std\+::string \mbox{\hyperlink{telegram__auth_8h_ac261e08f76f7e7de9a1ace511ead28c5}{BOT\+\_\+\+TOKEN}}
\begin{DoxyCompactList}\small\item\em Глобальный токен Telegram-\/бота, используется при отправке сообщений. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Описание\+:
\begin{DoxyItemize}
\item Использует Telegram Bot API для отправки одноразовых кодов авторизации.
\item Хранит сгенерированные коды в глобальной карте auth\+\_\+codes. 
\end{DoxyItemize}

Definition in file \mbox{\hyperlink{telegram__auth_8h_source}{telegram\+\_\+auth.\+h}}.



\doxysubsection{Function Documentation}
\Hypertarget{telegram__auth_8h_addc2662ff5190602846d5e93f09aa388}\label{telegram__auth_8h_addc2662ff5190602846d5e93f09aa388} 
\index{telegram\_auth.h@{telegram\_auth.h}!ensure\_bot\_token@{ensure\_bot\_token}}
\index{ensure\_bot\_token@{ensure\_bot\_token}!telegram\_auth.h@{telegram\_auth.h}}
...
При первом вызове пытается считать токен из файла SERVER\+\_\+\+SETTINGS/\+BOT\+\_\+\+TOKEN.\+txt. Если файл отсутствует или пуст, создаёт его и выводит сообщение об ошибке. Завершает программу при отсутствии токена.
...
\end{DoxyCode}
\Hypertarget{telegram__auth_8h_a74d2f6718acaf08c27fb5c975a939cca}\label{telegram__auth_8h_a74d2f6718acaf08c27fb5c975a939cca} 
\index{telegram\_auth.h@{telegram\_auth.h}!generate\_auth\_code@{generate\_auth\_code}}
\index{generate\_auth\_code@{generate\_auth\_code}!telegram\_auth.h@{telegram\_auth.h}}
...
Код состоит из цифр \mbox{[}0-\/9\mbox{]} и всегда имеет длину 6 символов.
...
\end{DoxyCode}
\Hypertarget{telegram__auth_8h_ad0aadb96417fb892ae3cdaf3e4b24649}\label{telegram__auth_8h_ad0aadb96417fb892ae3cdaf3e4b24649} 
\index{telegram\_auth.h@{telegram\_auth.h}!send\_telegram\_code@{send\_telegram\_code}}
\index{send\_telegram\_code@{send\_telegram\_code}!telegram\_auth.h@{telegram\_auth.h}}
...
{\em chat\+\_\+id} & Идентификатор Telegram-\/чата получателя. \\
\hline
{\em code} & Шестизначный код, который будет отправлен. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyCode}
\Hypertarget{telegram__auth_8h_a49e6447c01a81c8af7c206e1538510a0}\label{telegram__auth_8h_a49e6447c01a81c8af7c206e1538510a0} 
\index{telegram\_auth.h@{telegram\_auth.h}!set\_bot\_token@{set\_bot\_token}}
\index{set\_bot\_token@{set\_bot\_token}!telegram\_auth.h@{telegram\_auth.h}}
...
Сохраняет переданный {\ttfamily token} для последующих HTTP-\/запросов.


\begin{DoxyParams}{Parameters}
{\em token} & Строка токена, выданная Bot\+Father.\\
\hline
\end{DoxyParams}
Установить глобальный токен Telegram-\/бота.
...
\end{DoxyCode}
\Hypertarget{telegram__auth_8h_a0bd7efd131f04d1c39a7e97276c64457}\label{telegram__auth_8h_a0bd7efd131f04d1c39a7e97276c64457} 
\index{telegram\_auth.h@{telegram\_auth.h}!verify\_auth\_code@{verify\_auth\_code}}
\index{verify\_auth\_code@{verify\_auth\_code}!telegram\_auth.h@{telegram\_auth.h}}
...
\begin{DoxyParams}{Parameters}
{\em chat\+\_\+id} & Идентификатор Telegram-\/чата, для которого код генерировался. \\
\hline
{\em code} & Код, введённый пользователем. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\Hypertarget{telegram__auth_8h_ac261e08f76f7e7de9a1ace511ead28c5}\label{telegram__auth_8h_ac261e08f76f7e7de9a1ace511ead28c5} 
\index{telegram\_auth.h@{telegram\_auth.h}!BOT\_TOKEN@{BOT\_TOKEN}}
\index{BOT\_TOKEN@{BOT\_TOKEN}!telegram\_auth.h@{telegram\_auth.h}}
\doxysubsubsection{\texorpdfstring{BOT\_TOKEN}{BOT\_TOKEN}}
{\footnotesize\ttfamily std\+::string BOT\+\_\+\+TOKEN\hspace{0.3cm}{\ttfamily [extern]}}
